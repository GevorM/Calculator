      ...
      <div class="buttons">
        <div class="__left-panel">
          <div class="__small-numbers">
            <number-button size="small" color="standard" type="number" @click="calculate($event,E,'e')">e
            </number-button>
            <number-button size="small" color="standard" type="number" @click="calculate($event,P,'µ')">µ
            </number-button>
            <number-button size="small" color="standard" type="number" @click="calculate($event,P,'sin')">sin
            </number-button>
          </div>
          <div class="__normal-numbers">
            <number-button size="normal" color="lightGray" type="action" @click="calculate($event,'Ac')">Ac
            </number-button>
            <number-button size="normal" color="lightGray" type="action" @click="calculate($event,'x')">
            ...
            <number-button size="normal" color="blue" type="operator" @click="calculate($event,Operators.DIVISION)">/</number-button>
          </div>
          <div class="__normal-numbers">
            <number-button size="normal" color="standard" type="number" @click="calculate($event,7)">7</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,8)">8</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,9)">9</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,4)">4</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,5)">5</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,6)">6</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,1)">1</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,2)">2</number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,3)">3</number-button>
          </div>
          <div class="__vertical-numbers">
            <number-button size="vertical" color="standard" type="number" @click="calculate($event,0)">0
            </number-button>
            <number-button size="normal" color="standard" type="number" @click="calculate($event,'.')">.
            </number-button>
          </div>
        </div>
        <div class="__right_panel">
          <div class="__numbers">
            ...
            <number-button size="normal" color="blue" type="operator"
                           @click="calculate($event,Operators.MULTIPLICATION)">*
            </number-button>
            <number-button size="normal" color="blue" type="operator" @click="calculate($event,Operators.SUBTRACTION)">
              -
            </number-button>
            <number-button size="horizontal" color="blue" type="operator"
                           @click="calculate($event,Operators.ADDITION)">+
            </number-button>
            <number-button size="horizontal" color="lightBlue" type="operator"
                           @click="calculate($event,Operators.EQUAL)">=
            </number-button>
          </div>
        </div>
      </div>
...
function calculate(calcType: CalcType, value: string | number, numberType: string) {
  isShowEqual()
...
function isTypeOperator(value: string | number) {
  if((value === '*' || value === '/') && convertCalculateValueToArray().length === 1) {
    return
  }
...
function isOperator(operator): boolean {
  const values: Array<Object> = Object.values(Operators);
